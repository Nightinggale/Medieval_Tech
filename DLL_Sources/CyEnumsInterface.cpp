...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_PEDIA_JUMP_TO_TRADE_TECH", WIDGET_PEDIA_JUMP_TO_TRADE_TECH)
		.value("WIDGET_PEDIA_JUMP_TO_CENSURES", WIDGET_PEDIA_JUMP_TO_CENSURES)
		//TK Tax
	...
	python::enum_<CivilopediaPageTypes>("CivilopediaPageTypes")
		...
		.value("CIVILOPEDIA_PAGE_TRADE_TECHS", CIVILOPEDIA_PAGE_TRADE_TECHS)
		.value("CIVILOPEDIA_PAGE_CENSURES", CIVILOPEDIA_PAGE_CENSURES)
		///TKe
